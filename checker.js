! function() {
	...
	(t => {
		const {
			...
			currentScript: f,
			referrer: p
		} = c, g = h.startsWith("data:") ? void 0 : t.localStorage;
		if(!f) return;
		const y = "data-",
			b = "true",
			...
			_ = (t, e, a) => {
				a && (R = P, P = new URL(a, o.href), A && (P.search = ""), j && (P.hash = ""), P = P.toString(), P !== R && setTimeout(C, K))
			},
			B = () => F || !N || g && g.getItem("umami.disabled") || x && !O.includes(d) || k && (() => {
				const t = l || n || i;
			...
			C = (t, e) => W("string" == typeof t ? {...U(), name: t, data: "object" == typeof e ? e : void 0
			} : "object" == typeof t ? t : "function" == typeof t ? t(U()) : U()),
			I = t => W({...U(), data: t
			}, "identify");
		t.umami || (t.umami = {
			track: C,
